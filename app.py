...
def main():
    global counter
    st.title("Universe Chatbot - by Mohammad Ali")
    ...
    # Home Menu
    if choice == "Home":
        st.write("Welcome to the chatbot. Please type \"Hi\" or \"Help me\" to start the conversation.")
    ...
    # Conversation History Menu
        ...
        - Intents: The intent of the user input (e.g. "greeting", "planets", "stars")
        - Entities: The entities extracted from user input (e.g. "Hi", "Tell me about Stars", "What is a milky way")
